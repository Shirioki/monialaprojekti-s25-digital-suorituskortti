...
import { getTaskById, submitTask, Task } from '../utils/taskManager'
      ...
      <View key={field.id} style={styles.section}>
        ...
        {field.type === 'textInput' && (
          <TextInput
            ...
            onChangeText={(text) =>
              updateWorkCardValue(field.id, text)
            }
            multiline
          ...
          <View>
            ...
            {field.options.map((option: string, index: number) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  toggleMultipleChoice(field.id, option)
                }
              >
        ...
        {field.type === 'checkbox' && (
          <TouchableOpacity
            ...
            onPress={() =>
              updateWorkCardValue(field.id, !workCardValues[field.id])
            }
            activeOpacity={0.7}
          >
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        {/* Work Card Badge */}
        {task.type === 'workcard' && (
          <View style={styles.workCardBanner}>
            <Ionicons name="clipboard" size={20} color="#007AFF" />
            <Text style={styles.workCardBannerText}>Suorituskortti</Text>
          </View>
        )}
          ...
          <>
            ...
            <View style={styles.section}>
              ...
              <TextInput
                ...
                placeholder="Kirjoita itse arvio siitä, miten sait tehtävän valmiiksi..."
